...
<div class="container">
  <h2>Raspored</h2>
  <p>Stvori novu tablicu:</p>

<form action='includes/setHeadings.inc.php' method='POST'>
      <div class='input-group mb-3'>
              <div class='input-group-prepend'>
                <span class='input-group-text' id='inputGroup-sizing-sm'>Izradio:</span>
              </div>
              <input type='text' class='form-control mr-3' name='createdby' width="300" required> 

              <div class='input-group-prepend'>
                <span class='input-group-text' id='inputGroup-sizing-sm'>Naslov</span>
              </div>
              <input type='text' class='form-control mr-3' name='heading' required>

              <div class='input-group-prepend'>
                <span class='input-group-text' id='inputGroup-sizing-sm'>Broj tjedna</span>
                <input type='text' class='form-control' name='numberofweek' required>
              </div>

              <div class='input-group-prepend mt-4'>
                
                <span class='input-group-text' id='inputGroup-sizing-sm'>Od</span>
                <input class="mr-3" id="startDate" name="datefrom" width="276" required />
               <span class='input-group-text' id='inputGroup-sizing-sm'>Do</span>
                <input id="endDate" name="dateto" width="276" required />
              </div>
              
          <div class='ml-4 mt-4'>
            <input type='submit' class='btn btn-outline-secondary' type='button' name='submit' value='Stvori novu tablicu'/>
          </div>
        </div>
      </form>
...
<hr>
 ...
 <?php 
      $sql = "SELECT * FROM scheduleheadings ORDER BY id DESC;";
      ...
      if ($resultCheck > 0) {
        ...
        echo "<i>Izradio: ".$row['createdby']."</i>";
        echo "</div>";
        echo "<div class='col-sm'>";
        echo "<h5>".$row['heading']."</h5>";
        echo "</div>";
        echo "<div class='col-sm'>";
        echo "<p>Broj tjedna: ".$row['numberofweek']."</p>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
        echo "<h6>Od: ".$row['datefrom']."</h6>";
        echo "<h6>Do: ".$row['dateto']."</h6>";
        echo "<div class='clearfix'></div>";
        echo "<div class='table-responsive-sm'>   

              <form method='POST' action='includes/setScheduleName.inc.php'>
              <table class='table'>
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    <td><input type='text' class='form-control' name='monday' aria-label='Small' aria-describedby='inputGroup-sizing-sm'></td>
                    <td><input type='text' class='form-control' name='tuesday' aria-label='Small' aria-describedby='inputGroup-sizing-sm'></td>
                    <td><input type='text' class='form-control' name='wednesday' aria-label='Small' aria-describedby='inputGroup-sizing-sm'></td>
                    <td><input type='text' class='form-control' name='thursday' aria-label='Small' aria-describedby='inputGroup-sizing-sm'></td>
                    <td><input type='text' class='form-control' name='friday' aria-label='Small' aria-describedby='inputGroup-sizing-sm'></td>
                    <td><input type='text' class='form-control' name='saturday' aria-label='Small' aria-describedby='inputGroup-sizing-sm'>
                    </td>
                  </tr>
                </tbody>
              </table>
                  ...
                  <button type='submit' class='btn btn-outline-secondary btn-sm mb-4' name='createNewRow'>Stvori novi redak</button>

                   <button type='submit' class='btn btn-outline-secondary btn-sm mb-4' name='finishTable'>Završi tablicu</button>
                  </div>
                  </div>
                  </form>
              </div>";
